...
public class MazeConstants {
    ...
    public static final int VERTEX_NUMBER = 40 * 40;
    // the borders
    public static final Border BLANK_BORDER = BorderFactory.createMatteBorder(1, 1, 1, 1, Color.WHITE);
    public static final Border RIGHT_BORDER = BorderFactory.createMatteBorder(0, 0, 0, 1, Color.DARK_GRAY);
    public static final Border TOP_BORDER = BorderFactory.createMatteBorder(1, 0, 0, 0, Color.DARK_GRAY);
    public static final Border BOTTOM_BORDER = BorderFactory.createMatteBorder(0, 0, 1, 0, Color.DARK_GRAY);
    public static final Border LEFT_BORDER = BorderFactory.createMatteBorder(0, 1, 0, 0, Color.DARK_GRAY);
